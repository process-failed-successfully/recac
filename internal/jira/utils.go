...
// ExtractRequiredFeatures parses a text description for a section starting with
// "REQUIRED FEATURES" or "ACCEPTANCE CRITERIA" and extracts list items as features.
