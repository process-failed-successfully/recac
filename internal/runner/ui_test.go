...
func TestSession_RunLoop_UIVerification(t *testing.T) {
	...
	// ErrNoOp is expected if MockAgent returns empty responses.
	// ErrMaxIterations is expected if MockAgent returns commands but doesn't complete the task within limit.
