...
func TestSession_RunLoop_UIVerification(t *testing.T) {
	...
	s := &Session{
		...
		MaxIterations:    1, // Limit iterations to prevent infinite loops
	}
	...
	// ErrMaxIterations is also acceptable if it completes the iteration without finishing the project.
