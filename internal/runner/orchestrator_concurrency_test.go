...
func (m *MockDockerForOrchestrator) RunContainer(ctx context.Context, image, workspace string, extraBinds []string, env []string, labels map[string]string, user string) (string, error) {
