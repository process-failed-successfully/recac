...
func TestMockAgent_TicketGeneration(t *testing.T) {
	agent := NewMockAgent()
	prompt := "You are a Technical Program Manager. Please generate tickets for ID:[PRIMES] from app_spec.txt"
...
func TestMockAgent_Implementation(t *testing.T) {
	agent := NewMockAgent()
	prompt := "Please implement the task: primes.py. Calculate primes less than 10,000."
