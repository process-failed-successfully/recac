...
func (m *MockAgent) Send(ctx context.Context, prompt string) (string, error) {
		...
		return `[
  {
	...
	// We check for multiple triggers to be robust against prompt variations
	if strings.Contains(prompt, "primes.py") || strings.Contains(prompt, "[PRIMES]") || strings.Contains(prompt, "Prime Number Generator") {
