...
func (m *MockAgent) Send(ctx context.Context, prompt string) (string, error) {
	...
	// If the prompt looks like the Prime Python spec, return a response that creates and runs the script.
	// We match "ID:[PRIMES]" to catch variations in the prompt summary.
