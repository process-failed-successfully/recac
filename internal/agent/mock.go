...
agent-bridge feature set req-primes-py-exists --status implemented --passes true
agent-bridge feature set req-primes-json-exists --status implemented --passes true
` + "\n```"
}
