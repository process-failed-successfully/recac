...
func (m *MockAgent) Send(ctx context.Context, prompt string) (string, error) {
	...
	if (strings.Contains(prompt, "[PRIMES]") || strings.Contains(prompt, "primes.py") || strings.Contains(prompt, "req-script-prints-primes") || strings.Contains(prompt, "req-script-is-runnable")) &&
