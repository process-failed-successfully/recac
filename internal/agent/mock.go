...
`, nil
		...
		return fmt.Sprintf(`[
  {
	...
	if strings.Contains(lowerPrompt, "qa agent") || strings.Contains(lowerPrompt, "manager review") || strings.Contains(lowerPrompt, "manager agent") || strings.Contains(lowerPrompt, "project manager") {
		return `
