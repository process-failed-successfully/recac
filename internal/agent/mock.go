...
agent-bridge feature set "req-implement-prime-calculation-lo" --status done --passes true || true
agent-bridge feature set "req-output-results-to-primes-json" --status done --passes true || true
agent-bridge feature set "req-verify-that-exactly-1229-prime" --status done --passes true || true
