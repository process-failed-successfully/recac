...
func (m *MockAgent) Send(ctx context.Context, prompt string) (string, error) {
	...
	// "req-must-correctly-identify-prime-" is the feature ID generated by the Initializer.
	// The Coding Agent prompt contains this ID but NOT "[PRIMES]" or "primes.py" directly in the template structure.
