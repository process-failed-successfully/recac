...
func (m *MockAgent) Send(ctx context.Context, prompt string) (string, error) {
	...
	if strings.Contains(prompt, "app_spec.txt") || strings.Contains(prompt, "Technical Program Manager") {
		...
		// We return a single Task to avoid creating unhandled child stories that trip the circuit breaker.
		return `[
  {
    "title": "ID:[PRIMES] Implement Prime Number Generator",
    "description": "This is a mock task generated by the MockAgent to implement primes.py.",
    "type": "Task",
    "acceptance_criteria": [
