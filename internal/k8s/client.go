...
// GetPodLogs returns a stream of logs for a specific pod.
func (c *Client) GetPodLogs(ctx context.Context, name string, opts *corev1.PodLogOptions) (io.ReadCloser, error) {
