...
func TestDashboardModel_ConfirmationFlow_MultipleActions(t *testing.T) {
	columns := []table.Column{
		{Title: "ID", Width: 10},
		{Title: "Status", Width: 10},
	}
	...
	testCases := []struct {
		...
		{"promote multiple", "PROMOTE 2 selected"},
