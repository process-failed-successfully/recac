...
func (m *MockStore) QueryHistory(projectID string, limit int) ([]db.Observation, error) {
	return nil, nil
}
...
func (m *MockStore) UpdateFeatureStatus(projectID, id string, status string, passes bool) error {
	return nil
}
func (m *MockStore) AcquireLock(projectID, path, agentID string, timeout time.Duration) (bool, error) {
	return true, nil
}
