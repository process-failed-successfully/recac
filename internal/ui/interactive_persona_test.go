...
// setupTestEnvironment isolates the persona file loading
func setupTestEnvironment(t *testing.T) {
	t.Helper()
	tmpDir := t.TempDir()
	t.Setenv("RECAC_PERSONAS_FILE", filepath.Join(tmpDir, "personas.yaml"))
}
...
func TestInteractiveModel_Persona_Selection(t *testing.T) {
	...
	// Explicitly inject the persona we are testing for
