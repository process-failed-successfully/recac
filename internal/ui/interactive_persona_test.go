...
func setupTestEnvironment(t *testing.T) {
	...
	// Point to a non-existent file to force loading of DefaultPersonas
	t.Setenv("RECAC_PERSONAS_FILE", filepath.Join(t.TempDir(), "non-existent.yaml"))
}
...
func TestInteractiveModel_Persona_PromptInjection(t *testing.T) {
	...
	// Removed incorrect double invocation
	msg := cmd()
