...
func TestInteractiveModel_Persona_Selection(t *testing.T) {
	...
	// Explicitly inject "junior" persona to ensure test stability
...
func TestInteractiveModel_Persona_PromptInjection(t *testing.T) {
	...
	// Explicitly inject "teacher" persona
	...
	// Run the command once. It returns the message and starts the goroutine.
	msg := cmd()
