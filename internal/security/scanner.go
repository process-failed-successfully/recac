...
var (
	...
	reDangerousCmd    = regexp.MustCompile(`(?i)\b(rm|cat|cp|mv|chmod|chown)\b.*?[\s/<>\"'\\]([.]ssh|[.]aws|[.]config|[.]gemini|/etc/passwd|/etc/shadow|[.]env|[.]git-credentials|[.]netrc|/proc/self/[e]nviron)`)
