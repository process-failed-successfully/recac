...
var (
	...
	reDangerousCmd    = regexp.MustCompile(`(?i)\b(rm|cat|cp|mv|chmod|chown)\b.*?[\s/<>"'\\]([.]ssh|[.]aws|[.]config|[.]gemini|/etc/pass[w]d|/etc/shad[o]w|[.]env|[.]git-credentials|[.]netrc|/proc/self/envir[o]n)`)
