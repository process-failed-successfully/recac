...
func (m *MockGitClient) Checkout(directory, branch string) error          { return nil }
...
func (m *MockGitClient) CurrentBranch(directory string) (string, error) { return "main", nil }
