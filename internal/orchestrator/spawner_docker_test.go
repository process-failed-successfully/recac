...
type mockDockerClient struct {
	RunContainerFn func(ctx context.Context, image, workspace string, extraBinds []string, ports []string, user string) (string, error)
...
func (m *mockDockerClient) RunContainer(ctx context.Context, image, workspace string, extraBinds []string, ports []string, user string) (string, error) {
	...
	if m.RunContainerFn != nil {
		return m.RunContainerFn(ctx, image, workspace, extraBinds, ports, user)
	}
