...
func (m *MockDockerClient) RunContainer(ctx context.Context, image, workspace string, binds []string, env []string, labels map[string]string, user string) (string, error) {
