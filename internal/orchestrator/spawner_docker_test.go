...
func (m *MockDockerClient) RunContainerWithConfig(ctx context.Context, image, workspace string, binds, env []string, labels map[string]string, user string) (string, error) {
...
func TestDockerSpawner_Spawn_Success(t *testing.T) {
	...
	// Mock expectations
	mockDocker.On("RunContainerWithConfig", ctx, "test-image", mock.AnythingOfType("string"), mock.Anything, mock.Anything, mock.MatchedBy(func(l map[string]string) bool {
		return l["created-by"] == "recac-orchestrator" && l["ticket"] == "TICKET-1"
...
func TestDockerSpawner_Spawn_RunContainerFails(t *testing.T) {
	...
	mockDocker.On("RunContainerWithConfig", ctx, "test-image", mock.AnythingOfType("string"), mock.Anything, mock.Anything, mock.Anything, "").Return("", expectedErr)
...
func TestDockerSpawner_ShellInjection(t *testing.T) {
	...
	client.On("RunContainerWithConfig", mock.Anything, "recac-agent:latest", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return("container-123", nil)
...
func TestDockerSpawner_EnvPropagation(t *testing.T) {
	...
	client.On("RunContainerWithConfig", mock.Anything, "recac-agent:latest", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return("container-env", nil)
	sm.On("SaveSession", mock.Anything).Return(nil)
	sm.On("LoadSession", mock.Anything).Return(&runner.SessionState{}, nil)
