...
func TestDockerSpawner_Spawn_Success(t *testing.T) {
	...
	// Mock expectations
	mockDocker.On("RunContainerWithLabels", ctx, "test-image", mock.AnythingOfType("string"), mock.Anything, mock.Anything, "", mock.AnythingOfType("map[string]string")).Return("container123", nil)
...
func TestDockerSpawner_Spawn_RunContainerFails(t *testing.T) {
	...
	mockDocker.On("RunContainerWithLabels", ctx, "test-image", mock.AnythingOfType("string"), mock.Anything, mock.Anything, "", mock.AnythingOfType("map[string]string")).Return("", expectedErr)
