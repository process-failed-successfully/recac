...
type DockerClient interface {
	...
	RunContainerWithLabels(ctx context.Context, image string, workspace string, binds []string, ports []string, env []string, user string, labels map[string]string) (string, error)
