        ...
        <div id="submitModal" class="modal">
            <div class="modal-content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="job-concurrency-group" placeholder="e.g., build-frontend">
                </div>
                <div class="form-group" style="display: flex; align-items: center; gap: 10px;">
                    <input type="checkbox" id="job-cancel-in-progress" style="width: auto;">
                    <label for="job-cancel-in-progress" style="margin: 0; font-weight: normal;">Cancel In Progress</label>
                </div>
                <div class="form-group">
