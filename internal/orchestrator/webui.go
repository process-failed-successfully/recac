    ...
    <div class="container">
        <div class="controls" style="margin-top: 20px;">
            ...
            <div>
                ...
                <button type="button" aria-label="Submit Job" onclick="document.getElementById('submitModal').style.display='block'; setTimeout(() => document.getElementById('job-summary').focus(), 10);" aria-keyshortcuts="s" title="Shortcut: 's'" style="background-color: #28a745;">+ Submit Job</button>
            </div>
        </div>
