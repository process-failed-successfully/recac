...
func TestSpawnerConsistency_EnvPropagation(t *testing.T) {
	...
	t.Run("DockerSpawner propagates all config vars", func(t *testing.T) {
		...
		// Expectations
		mockDocker.On("RunContainerWithLabels", mock.Anything, "img", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return("cid", nil)
