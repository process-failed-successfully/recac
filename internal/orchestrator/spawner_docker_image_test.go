...
func TestDockerSpawner_Spawn_ImageFlag(t *testing.T) {
	...
	// Mock expectations
	mockDocker.On("RunContainerWithLabels", ctx, imageName, mock.AnythingOfType("string"), mock.Anything, mock.Anything, "", mock.AnythingOfType("map[string]string")).Return("container123", nil)
