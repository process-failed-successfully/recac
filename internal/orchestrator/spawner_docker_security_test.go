...
func TestDockerSpawner_EnvInjection_Vulnerability(t *testing.T) {
	...
	client.On("RunContainerWithConfig", mock.Anything, "recac-agent:latest", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return("container-sec", nil)
