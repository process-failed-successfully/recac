...
func TestSubmitAdHocJob_SuccessNoWait(t *testing.T) {
	...
	submitAdHocJob(server.URL, "repo", "task", "id", 0, 0, 0, nil, nil, nil, nil, false, nil, nil, nil, "", false, "", "", "", "", false)
...
func TestSubmitAdHocJob_SuccessWait(t *testing.T) {
	...
	submitAdHocJob(server.URL, "repo", "task", "id", 0, 0, 0, nil, nil, nil, nil, true, nil, nil, nil, "", false, "", "", "", "", false)
