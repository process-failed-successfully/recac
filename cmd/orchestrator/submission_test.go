...
func TestSubmitAdHocJob(t *testing.T) {
	...
	submitAdHocJob(server.URL, "http://repo.com", "My Task", "MY-ID", 0, 0, 0, nil, nil, nil, nil, false, envVars, submitDeps, nil, "group-1", true, "custom-provider", "custom-model", "", "")
...
func TestSubmitAdHocJob_AutoID(t *testing.T) {
	...
	submitAdHocJob(server.URL, "http://repo.com", "My Task", "", 0, 0, 0, nil, nil, nil, nil, false, nil, nil, nil, "", false, "", "", "", "")
