...
func TestPurgeJobsOlderThan_Success(t *testing.T) {
...
func TestPurgeJobsOlderThan_APIError(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
	...
	assert.Contains(t, buf.String(), "Failed to purge jobs older than invalid: invalid duration")
}

func TestPurgeJobsOlderThan_Errors(t *testing.T) {
	origExit := exitFunc
	...
	t.Run("InvalidURL", func(t *testing.T) {
		...
		purgeJobsOlderThan("http://\x00invalid", "24h")
	...
	t.Run("ConnectionError", func(t *testing.T) {
		...
		purgeJobsOlderThan("http://localhost:12345", "24h")
		assert.Equal(t, 1, exitCode)
