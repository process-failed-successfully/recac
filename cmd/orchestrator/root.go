...
var rootCmd = &cobra.Command{
	Use:   "orchestrator",
	Short: "RECAC Orchestrator polling for tasks and spawning agents",
	Long: `The RECAC Orchestrator is responsible for polling task sources (Jira, GitHub, Files)
and spawning RECAC Agents to handle the work. It supports both local Docker execution
and Kubernetes Job distribution.`,
...
func init() {
	...
	viper.BindPFlag("orchestrator.mode", rootCmd.Flags().Lookup("mode"))
