...
var rootCmd = &cobra.Command{
	...
	Long:  `Polls for tasks and spawns agents to complete them.`,
	Run:   runDaemon,
}
...
func init() {
	...
	rootCmd.PersistentFlags().String("work-file", "work_items.json", "Work items file (for 'file' poller and 'task' command)")
