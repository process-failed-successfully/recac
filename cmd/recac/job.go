...
func init() {
	...
	// List command
	jobListCmd.Flags().Bool("all", false, "Include completed jobs")
	...
	// Submit flags
	jobSubmitCmd.Flags().String("id", "", "Job ID")
	jobSubmitCmd.Flags().String("summary", "", "Job Summary")
	jobSubmitCmd.Flags().String("description", "", "Job Description")
	jobSubmitCmd.Flags().String("repo-url", "", "Repository URL")

	// Persistent flags for job command
