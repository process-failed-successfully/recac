...
func init() {
	...
	orchestrateCmd.Flags().String("agent-provider", "google", "Provider for spawned agents")
	orchestrateCmd.Flags().String("agent-model", "google/gemini-2.0-flash-001", "Model for spawned agents")
