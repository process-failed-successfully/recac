...
var todoEstimateCmd = &cobra.Command{
	...
	Long:  `Reads a specific TODO item from TODO.md, identifies the file and context, and uses the AI agent to estimate complexity and effort.`,
...
Your goal is to ESTIMATE the effort required for the following TODO task found in the codebase.
