...
type mockSandboxClient struct {
	runContainerFunc    func(ctx context.Context, imageRef string, workspace string, extraBinds []string, env []string, labels map[string]string, user string) (string, error)
...
func (m *mockSandboxClient) RunContainer(ctx context.Context, imageRef string, workspace string, extraBinds []string, env []string, labels map[string]string, user string) (string, error) {
	if m.runContainerFunc != nil {
		return m.runContainerFunc(ctx, imageRef, workspace, extraBinds, env, labels, user)
	}
...
func TestSandboxCmd(t *testing.T) {
	...
	t.Run("Successful Run", func(t *testing.T) {
		...
		mockClient.runContainerFunc = func(ctx context.Context, imageRef string, workspace string, extraBinds []string, env []string, labels map[string]string, user string) (string, error) {
			runCalled = true
