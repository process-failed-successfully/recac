...
func (m *MockHomeSessionManager) ListSessions() ([]*runner.SessionState, error) {
...
func (m *MockHomeSessionManager) GetSessionLogContent(n string, l int) (string, error) {
	return "", nil
}
func (m *MockHomeSessionManager) StartSession(n, g string, c []string, w string) (*runner.SessionState, error) {
	return nil, nil
}
...
func (m *MockHomeSessionManager) ListArchivedSessions() ([]*runner.SessionState, error) {
	return nil, nil
}
