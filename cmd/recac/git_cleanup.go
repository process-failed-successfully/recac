...
// runGitCleanupTUI is a variable to allow mocking TUI execution in tests.
var runGitCleanupTUI = func(m tea.Model) (tea.Model, error) {
...
func runGitCleanup(cmd *cobra.Command, args []string) error {
	...
	finalModel, err := runGitCleanupTUI(m)
	if err != nil {
