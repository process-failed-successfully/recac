...
func (m *MockGitClientCommit) BisectLog(directory string) ([]string, error)     { return nil, nil }
func (m *MockGitClientCommit) BisectManualStart(directory string) error         { return nil }
