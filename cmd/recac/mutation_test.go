...
`
	...
	if err == nil {
		...
		t.Errorf("Expected 'mutation score below 100%%' error, got: %v. This might indicate infrastructure failure (baseline failed) or all mutants killed unexpectedly.", err)
	}
